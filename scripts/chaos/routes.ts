...
export const CHAOS_ROUTES: ChaosRoute[] = [
  ...
  { name: 'categories.dependencies', method: 'GET', path: (ctx) => `/api/v1/categories/${ctx.categoryId}/dependencies`, auth: 'none', mutates: false, weight: 1, group: 'public-read' },
  ...
  { name: 'questions.detail', method: 'GET', path: (ctx) => `/api/v1/questions/${ctx.questionId}`, auth: 'none', mutates: false, weight: 1, group: 'public-read' },
