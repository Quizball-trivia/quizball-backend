...
async function writeAwards(
  ...
  // Both branches must be TEXT: week_key is a date column, so a bare COALESCE
  // against a to_char() string fails with 42804 and rolls back settlement
  // (Aug-9 final incident).
