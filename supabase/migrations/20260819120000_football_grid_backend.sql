...
-- The hot public.matches / public.lobbies variant DDL was moved to
-- 20260819115900_football_grid_match_variant.sql (applied first) so the
-- exclusive table locks it needs are not held across this whole file.
